...
public class ManageInfo extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(addressTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 140, 170, -1));
        add(nameTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, 170, -1));
        ...
        add(numTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 90, 170, -1));
        ...
        add(SaveBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 220, -1, -1));
        ...
        add(UpdateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 220, -1, -1));
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        for(Hospital restro:system.getHospitalDirectory().getHospitalList()){
           if(restro.getAdminUName().equals(account.getUsername())){
                system.getHospitalDirectory().updateRestaurantInfo(restro,name, number, address);
            }
