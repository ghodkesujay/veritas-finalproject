 ...
 * @author sujayghodke
 */
public class ManageCollectionPoints extends javax.swing.JPanel {
    ...
    public ManageCollectionPoints(JPanel userProcessContainer, EcoSystem system) {
        initComponents();
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        CollectionPoint restro= system.getRestaurantDirectory().createRestaurantInfo(uname);
        populateNetworkTable();
