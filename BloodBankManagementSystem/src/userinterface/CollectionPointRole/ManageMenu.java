...
public class ManageMenu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(amtTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 440, 230, -1));
        ...
        add(descTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 390, 230, -1));
    ...
    private void populateTable() {
        ...
        for (CollectionPoint restro:system.getRestaurantDirectory().getRestaurantList()) {
            ...
            if (restro.getAdminUName().equals(account.getUsername())) {
               ...
               for(BloodRequirement menu:restro.getMenu()){
