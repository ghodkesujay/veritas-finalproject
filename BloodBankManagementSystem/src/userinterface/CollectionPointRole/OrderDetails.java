...
public class OrderDetails extends javax.swing.JPanel {
    ...
    EcoSystem system;
    public OrderDetails(JPanel userProcessContainer, UserAccount account, DonationRequest order, EcoSystem system) {
        initComponents();
    ...
    private void populateTable() {
        jLabel1.setText("Collection Request ID:"+order.getOrder_id());
         DefaultTableModel model = (DefaultTableModel) orderTable.getModel();
        model.setRowCount(0);
        
         
         Object[] row = new Object[3];
                for(BloodRequirement dish:order.getOrder()){
                     row[0] = dish;
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(174, 170, 530, 140));
        ...
        statusBtn.setText("Change Status to Blood Collected");
    ...
    private void statusBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_statusBtnActionPerformed
        ...
        order.setStatus("Blood Collected");
